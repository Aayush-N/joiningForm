...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('read', models.CharField(max_length=50, verbose_name='read')),
                ('speak', models.CharField(max_length=50, verbose_name='write')),
                ('write', models.CharField(max_length=50, verbose_name='speak')),
            ],
        ),
        migrations.CreateModel(
            name='MphilMca',
